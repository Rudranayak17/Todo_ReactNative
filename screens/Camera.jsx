...
const CameraComponent = () => {
  ...
  const openImagePickerAsync = async () => {
    ...
    if (!pickerResult.canceled) {
      ...
      if (route.params.updateProfile) {
        return navigation.navigate("profile", { image: selectedAssets[0].uri });
      } else {
        return navigation.navigate("register", { image: selectedAssets[0].uri });
      }
    }
  };
  ...
  return (
    <View style={{ flex: 1 }}>
      <Camera type={type} style={{ flex: 1, aspectRatio: 0.53 }} ratio="16:9" ref={(e) => setCamera(e)} />
